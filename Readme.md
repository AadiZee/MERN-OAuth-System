A full-stack authentication system built using MERN stack (MongoDB, Express, React, Node.js) and powered by Passport.js to manage multiple authentication strategies efficiently.</br>
</br>
🚀 Features </br>
</br>
